...
function Slider({
  ...
  return (
    <SliderPrimitive.Root
      className={cn(
        "rounded-full data-horizontal:w-full data-vertical:h-full",
        className,
      )}
      data-slot="slider"
      ...
      {...props}
    >
      <SliderPrimitive.Control className="relative flex w-full touch-none items-center rounded-full select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">
