...
export const runDaxTool = createTool({
  ...
  prompt: [
    ...
    "- Si N-1 est vide : vérifie d'abord les années disponibles avec `EVALUATE VALUES('Time'[FiscalYear])`, puis dis à l'utilisateur quelles années existent. Ne calcule pas d'écart sur du BLANK.",
